...
extension Date {
    func posHour() -> Date {
        return Date(timeIntervalSinceReferenceDate:
                        (timeIntervalSinceReferenceDate / (3600.0)).rounded(.towardZero) * (3600.0) + ((timeIntervalSinceReferenceDate / (3600.0)).rounded(.towardZero) * (3600.0) - (timeIntervalSinceReferenceDate / (3600.0 * 3.0)).rounded(.down) * (3600.0 * 3.0)))
    }
}
#Preview {
    BatteryView()
